...
import cn.org.byc.schedule.base.supports.Try;
import cn.org.byc.schedule.base.utils.ClassUtil;
import cn.org.byc.schedule.base.utils.ConvertUtils;
 ...
 */
public class ScheduleConvert implements Converter {
    private static final Logger LOGGER = LoggerFactory.getLogger(ScheduleConvert.class);
     ...
     */
    public ScheduleConvert(Class<?> targetClazz) {
        if (targetClazz == null) {
